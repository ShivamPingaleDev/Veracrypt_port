...
VC Port is **free**. Support helps the author keep working on it; it does **not** unlock features or stronger encryption. On GitHub: **About** sidebar + **Sponsor** heart (see [ports/SUPPORT.md](ports/SUPPORT.md)). Not inside the app.
