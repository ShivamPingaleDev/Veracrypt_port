        ...
        Form {
            ...
            Section("About / licenses") {
                ...
                Text("Shivam Mangesh Pingale — shivampingaledev@proton.me · shivampingaledev@gmail.com")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                Text("Optional support (opens browser): VC Port is free. Support does not unlock features or stronger encryption.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
                Link("GitHub Sponsors", destination: SupportLinks.githubSponsors)
                    .portTag("about_support_github")
                Link("Buy Me a Coffee", destination: SupportLinks.buyMeACoffee)
                    .portTag("about_support_bmac")
                Link("Ko-fi", destination: SupportLinks.koFi)
                    .portTag("about_support_kofi")
                Link("Liberapay", destination: SupportLinks.liberapay)
                    .portTag("about_support_liberapay")
