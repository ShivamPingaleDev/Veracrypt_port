...
| `experimental-otg-master` github flavor / iOS opt-in | none (same as master) | Fingerprint extra only. Live Check for updates is **not** here. `experimental-biometrics` is **stale**. |
