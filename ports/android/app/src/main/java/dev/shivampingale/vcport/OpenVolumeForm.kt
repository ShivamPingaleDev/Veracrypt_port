...
/**
 * One Open-volume form. Used on the Volume tab and in a Mounted empty slot
...
fun OpenVolumeForm(
    ...
    Column(
        ...
        if (mountedSlot) {
            Text(
                "Open a container into this Mounted slot. Same Open volume as the Volume tab: password, PIM, keyfiles, backup header, read-only, TrueCrypt Mode, hidden-volume protection, USB/OTG.",
