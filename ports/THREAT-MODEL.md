...
4. Do **not** tap Remember / biometrics if fingerprints can be compelled in your jurisdiction. Remember is **off by default** and requires typing `REMEMBER`. Volume-path history never hits `History.xml`.
