...
| Android preview | GitHub Release `v0.3.4` — one debug-signed FOSS APK (`VCPort-0.3.4.apk`) |
| iPhone preview | GitHub Release `v0.3.4` unsigned IPA (`VCPort-0.3.4-unsigned-preview.ipa`). Sign it yourself (see [FOSS.md](FOSS.md) / [ios/README.md](ios/README.md)). |
...
- Keep releases tagged (`v0.3.4`) so “VC Port 0.3.4” is a stable URL.
