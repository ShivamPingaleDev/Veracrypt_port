...
2. Android store builds use the `fdroid` product flavor (`./gradlew :app:assembleFdroidRelease`). The Looks APK (`assembleStyledRelease`, `dev.shivampingale.vcport.looks`) is a separate GitHub artifact, not the F-Droid app.
