...
class NamingAndAttributionTests(unittest.TestCase):
    ...
    def test_support_page_github_only(self) -> None:
        ...
        main = read("ports/android/app/src/main/java/dev/shivampingale/vcport/MainActivity.kt")
        view = read("ports/ios/VCPort/ContentView.swift")
        self.assertIn("github.com/sponsors/ShivamPingaleDev", support)
        ...
        self.assertIn("github: ShivamPingaleDev", funding)
        self.assertIn("ko_fi: shivampingaledev", funding)
        self.assertIn("liberapay: ShivamPingaleDev", funding)
        self.assertIn("buymeacoffee.com/shivampingaledev", funding)
