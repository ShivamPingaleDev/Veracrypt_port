...
class NamingAndAttributionTests(unittest.TestCase):
    ...
    def test_public_md_self_sign_and_honest_name(self) -> None:
        ...
        self.assertNotIn("02-wrap.png", readme)
        self.assertNotIn("ios-ipad-volume.png", readme)
        self.assertIn("your Apple ID", readme)
...
class AndroidHighThreatTests(unittest.TestCase):
    ...
    def test_mounted_tab_slot_column_on_android_and_ios(self) -> None:
        ...
        self.assertIn("tabState.intValue = 2", main)
        ...
        self.assertIn("selectedTab = 2", view)
        ...
        self.assertIn("mounted_open_dialog", main)
        self.assertIn("showOpenAnother", main)
        self.assertNotIn("openingAnother", main)
        ...
        self.assertIn(".sheet(isPresented: $showOpenAnother)", view)
...
class CrossPortGuiParityTests(unittest.TestCase):
    ...
    def test_volume_tools_on_android_and_ios(self) -> None:
        ...
        self.assertNotIn("Root / jailbreak", main)
        self.assertNotIn("Root / jailbreak", view)
