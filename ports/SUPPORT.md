...
## GitHub README badges (copy into README)

GitHub does not run `<script>` tags in Markdown. Use links and badge images instead.

```markdown
## Support (optional)

VC Port is free. Support helps the author; it does not unlock features or stronger encryption.
...
## Liberapay widget (personal website only)

For your own site (not GitHub README):

```html
<script src="https://liberapay.com/ShivamPingaleDev/widgets/button.js"></script>
<noscript><a href="https://liberapay.com/ShivamPingaleDev/donate"><img alt="Donate using Liberapay" src="https://liberapay.com/assets/widgets/donate.svg"></a></noscript>
```
...
Donations to **Mounir Idrassi / VeraCrypt** are separate: https://veracrypt.jp/en/Donation.html

## Hire / teach

Shivam Mangesh Pingale — shivampingaledev@proton.me · shivampingaledev@gmail.com

Open to teaching, internship, or employment. No pressure.
