...
VC Port is **free**. Support helps the author; it does **not** unlock features or stronger encryption. On GitHub: **About** sidebar + **Sponsor** heart ([SUPPORT.md](SUPPORT.md)). Not inside the app.
